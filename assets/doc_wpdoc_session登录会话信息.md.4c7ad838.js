import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.b1e56e49.js";const m=JSON.parse('{"title":"session登录会话信息","description":"","frontmatter":{"title":"session登录会话信息","date":"2020-07-03T17:54:44.000Z"},"headers":[],"relativePath":"doc/wpdoc/session登录会话信息.md","filePath":"doc/wpdoc/session登录会话信息.md"}'),l={name:"doc/wpdoc/session登录会话信息.md"},o=p(`<h1 id="_3-1-2-登录会话信息" tabindex="-1">3.1.2. 登录会话信息 <a class="header-anchor" href="#_3-1-2-登录会话信息" aria-label="Permalink to &quot;3.1.2. 登录会话信息&quot;">​</a></h1><p>SESSION对象为flycode内置对象，可获取到当前登录人的一些信息。</p><p><strong>API</strong></p><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#79B8FF;">SESSION</span><span style="color:#E1E4E8;">.orgcode;        </span><span style="color:#6A737D;">// 组织编码</span></span>
