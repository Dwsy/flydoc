import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.b1e56e49.js";const h=JSON.parse('{"title":"新时间表达式，支持周单位及链式写法","description":"","frontmatter":{"title":"新时间表达式，支持周单位及链式写法","date":"2021-04-12T19:09:37.000Z"},"headers":[],"relativePath":"doc/wpdoc/新时间表达式，支持周单位及链式写法.md","filePath":"doc/wpdoc/新时间表达式，支持周单位及链式写法.md"}'),l={name:"doc/wpdoc/新时间表达式，支持周单位及链式写法.md"},p=e(`<h1 id="新时间表达式" tabindex="-1">新时间表达式 <a class="header-anchor" href="#新时间表达式" aria-label="Permalink to &quot;新时间表达式&quot;">​</a></h1><ul><li>支持周单位</li><li>支持链式写法</li><li>在uiflycode上使用，加上System命名空间，如<div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">System.year(0)</span></span>
