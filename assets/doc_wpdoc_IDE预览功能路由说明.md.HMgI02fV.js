import{_ as s,c as n,o as a,U as p}from"./chunks/framework.FhXPyWfz.js";const m=JSON.parse('{"title":"IDE预览功能路由说明","description":"","frontmatter":{"title":"IDE预览功能路由说明","date":"2023-03-31T15:32:29.000Z"},"headers":[],"relativePath":"doc/wpdoc/IDE预览功能路由说明.md","filePath":"doc/wpdoc/IDE预览功能路由说明.md"}'),e={name:"doc/wpdoc/IDE预览功能路由说明.md"},r=p(`<h1 id="文档目的" tabindex="-1">文档目的 <a class="header-anchor" href="#文档目的" aria-label="Permalink to &quot;文档目的&quot;">​</a></h1><p>说明IDE中心路由增加UI预览后的路由适配</p><h1 id="场景描述" tabindex="-1">场景描述 <a class="header-anchor" href="#场景描述" aria-label="Permalink to &quot;场景描述&quot;">​</a></h1><p>原来的IDE路由只是nginx的简单代理。如下方显示</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>...</span></span>
