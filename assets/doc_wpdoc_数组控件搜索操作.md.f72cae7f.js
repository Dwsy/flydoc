import{_ as e,C as o,o as c,c as r,k as s,H as l,w as p,Q as t,a as n}from"./chunks/framework.d084db19.js";const k=JSON.parse('{"title":"数组控件搜索操作","description":"","frontmatter":{"title":"数组控件搜索操作","date":"2022-02-17T17:51:51.000Z"},"headers":[],"relativePath":"doc/wpdoc/数组控件搜索操作.md","filePath":"doc/wpdoc/数组控件搜索操作.md"}'),E={name:"doc/wpdoc/数组控件搜索操作.md"},y=t(`<h1 id="数组控件搜索操作" tabindex="-1">数组控件搜索操作 <a class="header-anchor" href="#数组控件搜索操作" aria-label="Permalink to &quot;数组控件搜索操作&quot;">​</a></h1><h3 id="search-searchparams" tabindex="-1"><strong>search(searchParams)</strong> <a class="header-anchor" href="#search-searchparams" aria-label="Permalink to &quot;**search(searchParams)**&quot;">​</a></h3><p>对数组型控件当前的数据进行搜索过滤</p><table><thead><tr><th>参数</th><th>类型</th><th>可空</th><th>说明</th></tr></thead><tbody><tr><td>searchParams</td><td>SearchParams</td><td>否</td><td>搜索条件</td></tr></tbody></table><h4 id="searchparams" tabindex="-1">SearchParams <a class="header-anchor" href="#searchparams" aria-label="Permalink to &quot;SearchParams&quot;">​</a></h4><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">var</span><span style="color:#E1E4E8;"> searchParams </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> {</span></span>
