import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.aac09c5f.js";const F=JSON.parse('{"title":"选项控件在数组控件内部的选项赋值方案","description":"","frontmatter":{"title":"选项控件在数组控件内部的选项赋值方案","date":"2020-05-20T16:01:22.000Z"},"headers":[],"relativePath":"doc/wpdoc/选项控件在数组控件内部的选项赋值方案.md","filePath":"doc/wpdoc/选项控件在数组控件内部的选项赋值方案.md"}'),p={name:"doc/wpdoc/选项控件在数组控件内部的选项赋值方案.md"},o=l(`<h1 id="选项控件在数组控件内部的选项赋值方案" tabindex="-1">选项控件在数组控件内部的选项赋值方案 <a class="header-anchor" href="#选项控件在数组控件内部的选项赋值方案" aria-label="Permalink to &quot;选项控件在数组控件内部的选项赋值方案&quot;">​</a></h1><h2 id="配置方案" tabindex="-1">配置方案 <a class="header-anchor" href="#配置方案" aria-label="Permalink to &quot;配置方案&quot;">​</a></h2><h3 id="_1-固定选项" tabindex="-1">1：固定选项 <a class="header-anchor" href="#_1-固定选项" aria-label="Permalink to &quot;1：固定选项&quot;">​</a></h3><p>即在控件协议中写死选项，这种适合于选项较少，且固定的情况，直接在对应控件中配置选项即可。</p><p>此时所有行的该控件的选项都是一致的。</p><div class="language-json vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">{</span></span>
