import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.d084db19.js";const b=JSON.parse('{"title":"ReportDataStructure","description":"","frontmatter":{"title":"ReportDataStructure","date":"2020-05-20T17:38:26.000Z"},"headers":[],"relativePath":"doc/wpdoc/ReportDataStructure.md","filePath":"doc/wpdoc/ReportDataStructure.md"}'),p={name:"doc/wpdoc/ReportDataStructure.md"},o=l(`<h1 id="report-data-structure" tabindex="-1">Report Data Structure <a class="header-anchor" href="#report-data-structure" aria-label="Permalink to &quot;Report Data Structure&quot;">​</a></h1><p>报表数据结构说明</p><h2 id="basic-基础数据结构" tabindex="-1">Basic 基础数据结构 <a class="header-anchor" href="#basic-基础数据结构" aria-label="Permalink to &quot;Basic 基础数据结构&quot;">​</a></h2><h1 id="pie" tabindex="-1">Pie <a class="header-anchor" href="#pie" aria-label="Permalink to &quot;Pie&quot;">​</a></h1><div class="language-json vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#9ECBFF;">&quot;protocols&quot;</span><span style="color:#E1E4E8;">: {</span></span>
