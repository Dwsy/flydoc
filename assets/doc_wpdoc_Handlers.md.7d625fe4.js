import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.b1e56e49.js";const b=JSON.parse('{"title":"Handlers","description":"","frontmatter":{"title":"Handlers","date":"2020-05-19T19:22:07.000Z"},"headers":[],"relativePath":"doc/wpdoc/Handlers.md","filePath":"doc/wpdoc/Handlers.md"}'),p={name:"doc/wpdoc/Handlers.md"},e=l(`<h2 id="handlers" tabindex="-1">Handlers <a class="header-anchor" href="#handlers" aria-label="Permalink to &quot;Handlers&quot;">​</a></h2><p>表单内部逻辑的放置区域，该区域的事件通常由控件触发，例如点击按钮，列表加载数据等。</p><p>handlers 中可以有多个独立的事件，每个事件由一系列的行为构成。</p><div class="language-json vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">{</span></span>
