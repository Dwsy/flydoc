import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.aac09c5f.js";const m=JSON.parse('{"title":"link链接按钮控件","description":"","frontmatter":{"title":"link链接按钮控件","date":"2020-11-04T09:59:38.000Z"},"headers":[],"relativePath":"doc/wpdoc/link链接按钮控件.md","filePath":"doc/wpdoc/link链接按钮控件.md"}'),l={name:"doc/wpdoc/link链接按钮控件.md"},o=e(`<h1 id="link链接按钮控件" tabindex="-1">link链接按钮控件 <a class="header-anchor" href="#link链接按钮控件" aria-label="Permalink to &quot;link链接按钮控件&quot;">​</a></h1><p>使用单纯的文字来作为一个按钮功能的控件，一般用于取代放在旧表格的按钮控件，支持配置对齐方式，支持配置下划线，以及一般的控件样式配置。</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">{</span></span>
